...
<body class="w3-white">
    ...
    <div class="w3-padding-128 w3-content w3-text-grey w3-center" id="">
        <h2 class="w3-text-purple ">Cadastro de Clientes</h2>
        <form action="#" method="post" class="w3-row w3-text-purple w3-center" style="width: 70%;">
            ...
            <div class="w3-row w3-section">
                ...
                <div class="w3-rest" style="">
                    <button name="btnBuscar" class="w3-button w3-purple w3-round-large w3-right" style="width: 95%;">Buscar Endereço</button>
                </div>
            </div>
            <div class="w3-row w3-section">
                <div class="w3-col" style="width:11%;">
            ...
            <div class="w3-row w3-section">
                <div class="w3-center" style="">
                    <button name="btnCadastrar" class="w3-button w3-block w3-margin w3-purple w3-cell w3-round-large" style="width: 90%;">Cadastrar</button>
                </div>
            </div>
        </form>
    </div>
